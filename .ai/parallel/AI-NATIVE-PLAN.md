...
| 65 | WS-0024-BENCHMARK-CAPTURE | Operator-safe repeated raw queue/E2E/reconciliation benchmark capture on a dedicated production-representative environment; no threshold inference | `worker-12/TASK-0024` | `tools/task0024_benchmark_capture.php`, `tools/test_task0024_benchmark_capture.py` |
