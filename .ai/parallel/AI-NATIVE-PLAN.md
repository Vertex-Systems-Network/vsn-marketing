...
Status: **staged** until TASK-0017 becomes the canonical active task.
...
|---:|---|---|---|---|---|---|---|---|
| 10 | WS-0017-RESEARCH-QA | TASK-0017 provider research + QA | **OPEN** | — | `awaiting_agent` | `agent/task-0017-research-qa` | squash | merge latest main before resume |
| 20 | WS-0017-BREVO | Brevo connector | **OPEN** | — | `awaiting_agent` | `agent/task-0017-brevo` | squash | merge latest main before resume |
| 20 | WS-0017-GMAIL | Gmail connector | **OPEN** | — | `awaiting_agent` | `agent/task-0017-gmail` | squash | merge latest main before resume |
| 20 | WS-0017-SES | Amazon SES connector | **OPEN** | — | `awaiting_agent` | `agent/task-0017-ses` | squash | merge latest main before resume |
| 30 | WS-0017-CONTRACT-MATRIX | Sandbox/negative contract matrix | **OPEN** | — | `awaiting_agent` | `agent/task-0017-contract-matrix` | squash | merge latest main before resume |
| 40 | WS-0017-SUPERVISOR-INTEGRATION | Shared integration and final acceptance | `occupied` | `supervisor-main` | `staged_waiting_for_task_activation` | `supervisor/task-0017-integration` | squash | merge latest main before resume |
