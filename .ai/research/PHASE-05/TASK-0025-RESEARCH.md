...
Date: 2026-09-15
Status: acceptance candidate for PHASE-05 research-first gate
Task: TASK-0025
...
| https://support.google.com/mail/answer/14229414 | Google Gmail Help — sender guidelines FAQ | 2026-09-15 | Gmail aggregates the approximately 5,000/day threshold by primary domain; once classified as a bulk sender the classification does not expire. Enforcement ramped up from November 2025. One-click unsubscribe is required for marketing/promotional traffic, not transactional traffic. |
| https://senders.yahooinc.com/best-practices/ | Yahoo Sender Hub | 2026-09-15 | Bulk-sender requirements include SPF + DKIM, passing DMARC with at least p=none, From alignment, one-click/list unsubscribe, visible body unsubscribe, unsubscribe handling within 2 days, and spam below 0.3%. Yahoo's reviewed official page does not define a universal numeric bulk-volume threshold; the product must not invent one. |
| https://techcommunity.microsoft.com/blog/microsoftdefenderforoffice365blog/strengthening-email-ecosystem-outlook%E2%80%99s-new-requirements-for-high%E2%80%90volume-senders/4399730 | Microsoft Defender for Office 365 Blog | 2026-09-15 | Outlook.com consumer domains require SPF, DKIM and DMARC for domains sending more than 5,000 messages/day. Non-compliant high-volume mail can be rejected with 550 5.7.515; enforcement took effect May 5, 2025. |
| https://www.rfc-editor.org/rfc/rfc8058.html | IETF RFC 8058 via RFC Editor | 2026-09-15 | One-click uses List-Unsubscribe with an HTTPS URI plus List-Unsubscribe-Post: List-Unsubscribe=One-Click. A valid DKIM signature must cover both headers. The POST must not depend on cookies, HTTP authorization, or prior browser context. |
| https://www.ftc.gov/business-guidance/resources/can-spam-act-compliance-guide-business | US Federal Trade Commission | 2026-09-15 | Commercial email must avoid deceptive headers/subjects, identify advertising as required, include a valid physical postal address and a clear opt-out. The opt-out mechanism must remain available for at least 30 days and requests must be honored within 10 business days; responsibility cannot simply be contracted away. |
| https://ico.org.uk/for-organisations/direct-marketing-and-privacy-and-electronic-communications/guidance-on-direct-marketing-using-electronic-mail/ | UK Information Commissioner's Office | 2026-09-15 | Guidance updated 28 April 2026. PECR distinguishes individual and corporate subscribers, consent/soft-opt-in cases, bought/public lists, and electronic-mail marketing responsibilities. The 2026 update adds a separate charitable-purposes soft opt-in under PECR regulation 22(3A). |
| https://ico.org.uk/about-the-ico/media-centre/news-and-blogs/2026/04/charities-given-new-flexibility-to-contact-supporters-under-data-law-change/ | UK Information Commissioner's Office | 2026-09-15 | The charitable-purposes soft opt-in came into force on 5 February 2026 under the Data (Use and Access) Act 2025. It may allow qualifying charities to contact people who expressed interest in or support for a charitable purpose without prior consent only where the statutory conditions are met. This is a distinct policy basis and must not be generalized into the ordinary commercial soft opt-in. |
| https://ico.org.uk/for-organisations/direct-marketing-and-privacy-and-electronic-communications/guidance-on-direct-marketing-using-electronic-mail/how-do-we-comply-with-the-pecr-electronic-mail-marketing-rules/ | UK Information Commissioner's Office | 2026-09-15 | Unsolicited marketing to individual subscribers needs consent or a valid applicable soft opt-in; unsolicited marketing to corporate subscribers does not use the same consent/soft-opt-in rule. Sender identity must not be hidden and a valid opt-out contact is required. Bought-list consent must specifically cover the sender and channel; the ordinary commercial soft opt-in requires direct collection. |
...
| https://eur-lex.europa.eu/legal-content/EN/ALL/?uri=CELEX%3A02016R0679-20160504 | EU GDPR, Article 21 | 2026-09-15 | A data subject may object to direct-marketing processing at any time; after objection, personal data must no longer be processed for that direct-marketing purpose. The right must be clearly brought to the person's attention. |
...
Disposition: provider-policy data must be effective-dated/versioned; no global `bulk_threshold = 5000` constant.

### R3 — Marketing and transactional mail require explicit classification

One-click unsubscribe requirements target marketing/promotional/subscribed traffic and are not a blanket rule for transactional messages. PHASE-05 policy therefore needs an explicit message-purpose/classification input rather than inferring purpose from template names or provider routes.
...
Provider/legal external deadlines differ: Yahoo requires applicable bulk-sender unsubscribes within 2 days while CAN-SPAM requires honoring opt-outs within 10 business days. The safer platform contract is therefore to make accepted unsubscribe/objection evidence effective in VSN eligibility immediately, while separately tracking downstream provider synchronization/reconciliation state. AI recommendations must never override suppression.
...
Google and Yahoo publish 0.3% as an important spam-complaint boundary, while Google additionally recommends staying materially below that level. These values are provider-specific deliverability health inputs, not consent or eligibility substitutes and not evidence that another provider shares the same threshold.
...
### R8 — UK charitable-purposes soft opt-in is a separate effective-dated basis

The 2026 charitable-purposes soft opt-in must be modeled separately from the ordinary commercial soft opt-in. Policy evaluation needs basis type, organization/charitable-purpose context, supporter-interest/support evidence, collection provenance, effective date and required opt-out conditions. A generic `soft_opt_in=true` flag is not sufficient and would risk cross-context authorization.

Disposition: configurable UK jurisdiction-policy requirement for TASK-0027/TASK-0028; no universal charity marketing permission is inferred.

### R9 — Bought/public lists require explicit provenance and cannot inherit generic permission

ICO guidance makes bought-list validity depend on specific consent naming the sender and channel, and public availability alone is not a universal marketing permission signal. Ordinary commercial soft-opt-in cannot be inherited from third-party list acquisition.
...
8. UK ordinary commercial soft opt-in and 2026 charitable-purposes soft opt-in are distinct effective-dated policy bases and cannot be collapsed into a shared boolean.
9. No anti-abuse evasion, account rotation, deceptive headers, spam-rate gaming or provider-limit circumvention is permitted.
...
- No legal conclusion that one provider or jurisdiction rule applies globally.
...
- UK charitable-purpose soft-opt-in details remain a jurisdiction-specific policy basis and should be revalidated against current ICO/PECR guidance when implemented.
...
Frozen hard acceptance requirements: provider-versioned authentication/bulk policy, explicit message purpose, RFC 8058 one-click semantics, deterministic immediate internal suppression, jurisdiction/subscriber-context policy, separate effective-dated UK charitable-purpose soft-opt-in handling, and fail-closed unknown context.
