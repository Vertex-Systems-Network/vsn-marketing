...
<!-- AI_PROGRESS_SNAPSHOT roadmap=48.45 phase=63.64 current_phase=PHASE-07 active_task=TASK-0039 milestone=TASK-0039-APPROVAL-MISSED-OUTCOMES status=COMPLETE -->

> Last verified protected-main TASK-0039 baseline: **2026-09-22** at `909fc90032fe8530cab7859ffa08af42642b1af7` after approval-timing/missed-occurrence PR #361 merged. Exact source `c5481f457526a55cd681af93e098ba41f2d90171` passed AI Continuity Guard `35788599628`, Application Foundation CI `35788599696`, and Security Supply Chain CI `35788599636`. AC-5 is trusted; AC-6 due claiming/execution-intent work is next and provider scheduling/publication side effects remain inactive.
>
...
**Current milestone: TASK-0039-APPROVAL-MISSED-OUTCOMES — COMPLETE**
...
| **PHASE-07** | **7%** | **Campaigns, Publishing, approvals, scheduling, unified calendar** | 🚧 **In progress — TASK-0039 AC-6 due-claim/execution-intent next** | **63.64%** |
...
TASK-0039 is active/in-progress in PHASE-07. PR #355 fixed-instant calendar/timezone foundation, PR #357 queue/next-slot foundation, PR #359 append-only reschedule/cancel history, and PR #361 canonical due-boundary approval/missed-occurrence history are trusted. The next bounded milestone is AC-6 PostgreSQL-authoritative due claiming with stale-lease recovery and one immutable internal execution intent plus durable outbox handoff per canonical occurrence.
...
README progress-sync protocol v2.4.2 remains enforced. PR #361 is trusted on exact source `c5481f457526a55cd681af93e098ba41f2d90171` and RBT-022 is terminal PASS. Deterministic progress remains roadmap 48.45% / PHASE-07 63.64% until TASK-0039 completes. AC-6 due-claim concurrency/execution-intent is next; provider scheduling/publication side effects remain inactive.
