...
return [
    ...
    'connections' => [
        ...
        'pgsql' => [
            ...
            'database' => env('DB_DATABASE', 'vsn_marketing'), 'username' => env('DB_USERNAME', 'vsn'),
            'password' => env('DB_PASSWORD', ''), 'charset' => 'utf8', 'prefix' => '',
            'prefix_indexes' => true, 'search_path' => 'public', 'sslmode' => env('DB_SSLMODE', 'prefer'),
        ],
    ],
    ...
    'redis' => [
        ...
        'options' => [
            ...
            'prefix' => env('REDIS_PREFIX', Str::slug((string) env('APP_NAME', 'vsn-marketing')).'-database-'),
        ],
        'default' => [
