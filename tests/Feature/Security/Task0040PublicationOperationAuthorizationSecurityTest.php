...
it('fails closed on current scope and app-review drift', function () {
    $fixture = Task0040PublicationFixture::create('operation-authority-drift');
    Task0040PublicationOperationFixture::addCapability($fixture, 'publication.update', 'authority-drift');
    $attempt = Task0040PublicationOperationFixture::terminalAttempt($fixture, PublicationAttemptState::Published);
    Task0040PublicationOperationFixture::observe(
        $fixture,
        $attempt,
